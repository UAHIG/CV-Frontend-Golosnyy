...
export default function Resume() {
  ...
  const education = [
    { year: '2024', course: 'Learn Microsoft Build JavaScript applications using TypeScript ()' },
    { year: '2024', course: 'UDEMY React REDUX full course.' },
    { year: '2023', course: 'RS School Course «JavaScript/Front-end»' },
    { year: '2022', course: 'LearnJS Java Script (learn.javascript.ru Course)' },
    { year: '2022', course: 'EPAM Front-End Self-Paced Online Program' },
    { year: '2013', course: 'X-Rite Color Theory & Color Master software Training' },
    { year: '2007', course: 'MIPE NTU "KhPI" Management of Administration and Economics' },
    { year: '2005', course: 'NTU "KhPI" Master of Electromechanical Engineering' },
    { year: '2003', course: 'NTU "KhPI" Bachelor of Electromechanical Engineering' }
  ]
          ...
          <div className="md:w-1/3 bg-gray-700 text-white p-8 space-y-4">
            ...
            <div className="space-y-2">
              ...
              <div className="flex items-center space-x-2">
                ...
                <a href="https://github.com/uahig" className="hover:underline">github.com/uahig</a>
              </div>
              <div className="flex items-center space-x-2">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                  <path fillRule="evenodd" d="M16.338 16.338H13.67V12.16c0-.995-.017-2.277-1.387-2.277-1.39 0-1.601 1.086-1.601 2.207v4.248H8.014v-8.59h2.559v1.174h.037c.356-.675 1.227-1.387 2.526-1.387 2.703 0 3.203 1.778 3.203 4.092v4.711zM5.005 6.575a1.548 1.548 0 11-.003-3.096 1.548 1.548 0 01.003 3.096zm-1.337 9.763H6.34v-8.59H3.667v8.59zM17.668 1H2.328C1.595 1 1 1.581 1 2.298v15.403C1 18.418 1.595 19 2.328 19h15.34c.734 0 1.332-.582 1.332-1.299V2.298C19 1.581 18.402 1 17.668 1z" clipRule="evenodd" />
                </svg>
                <a href="https://www.linkedin.com/in/uahig/" className="hover:underline">linkedin.com/in/uahig/</a>
              </div>
            </div>
            <div>
              ...
              <AnimatePresence mode="wait">
                {activeTab === 'skills' && (
                  ...
                  >
                    ...
                    <h3 className="text-xl font-semibold text-gray-700 mt-6">TOOLS</h3>
